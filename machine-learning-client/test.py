...
def test_upload_audio(global_client):
    ...
    with open(file_path, 'rb') as file:
        ...
        response = global_client.post('/upload', data=data, content_type='multipart/form-data')
...
def test_upload_without_audio(global_client):
    ...
    response = global_client.post('/upload', data={}, content_type='multipart/form-data')
...
def test_upload_with_wrong_file(global_client):
    ...
    with open(file_path, 'rb') as file:
        ...
        assert ValueError("Audio file could not be read as PCM WAV, "
